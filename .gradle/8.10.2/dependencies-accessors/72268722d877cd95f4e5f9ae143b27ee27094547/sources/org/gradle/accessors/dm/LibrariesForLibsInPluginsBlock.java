...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final SerializerLibraryAccessors laccForSerializerLibraryAccessors = new SerializerLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>serializer</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public SerializerLibraryAccessors getSerializer() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForSerializerLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class SerializerLibraryAccessors extends SubDependencyFactory {

        public SerializerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>moshi</b> with <b>io.github.jan-tennert.supabase:serializer-moshi</b> coordinates and
         * with version reference <b>serializerMoshi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getMoshi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("serializer.moshi");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>serializerMoshi</b> with value <b>VERSION</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSerializerMoshi() { return getVersion("serializerMoshi"); }
